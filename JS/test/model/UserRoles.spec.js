...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WestMarchesApi.UserRoles();
  });
  ...
  describe('UserRoles', function() {
    it('should create an instance of UserRoles', function() {
      ...
      //var instane = new WestMarchesApi.UserRoles();
      //expect(instance).to.be.a(WestMarchesApi.UserRoles);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new WestMarchesApi.UserRoles();
