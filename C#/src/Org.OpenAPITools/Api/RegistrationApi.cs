...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class RegistrationApi : IRegistrationApi
    {
        ...
        /// <returns></returns>
        public RegistrationApi(Org.OpenAPITools.Client.Configuration configuration)
        {
        ...
        public RegistrationApi(Org.OpenAPITools.Client.ISynchronousClient client, Org.OpenAPITools.Client.IAsynchronousClient asyncClient, Org.OpenAPITools.Client.IReadableConfiguration configuration)
        {
        ...
        public Org.OpenAPITools.Client.ApiResponse<Object> ApiRegistrationPostWithHttpInfo()
        {
            ...
            {
                Exception _exception = this.ExceptionFactory("ApiRegistrationPost", localVarResponse);
        ...
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<Object>> ApiRegistrationPostWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/api/registration", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
